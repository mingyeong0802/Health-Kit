...
cv2.imwrite('C:\\geumsangLee\\capston\\test_ocr\\ocr_ver2.0\\roi_img\\roi_img.png',image) 
#시스템 정리
...
#json 파일로 저장될 경로 지정
output_file = 'C:\\geumsangLee\\capston\\test_ocr\\ocr_ver2.0\\json_file\\img_json_file.json'
